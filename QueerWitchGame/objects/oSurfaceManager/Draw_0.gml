...
unit_outline_texel_width = texture_get_texel_width(surface_get_texture(unit_outline_surface));
unit_outline_texel_height = texture_get_texel_height(surface_get_texture(unit_outline_surface));
...
for (var k = 0; k < temp_unit_outline_map_size; k++) {
	...
	shader_set_uniform_f(uniform_pixel_width, unit_outline_texel_width);
	shader_set_uniform_f(uniform_pixel_height, unit_outline_texel_height);

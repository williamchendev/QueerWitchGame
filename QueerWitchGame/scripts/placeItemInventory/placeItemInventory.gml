/// placeItemInventory(inventory_object, item_id, item_x, item_y, item_width, item_height);
...
/// @param {integer} item_width The width of the item to place
/// @param {integer} item_height The height of the item to place
...
var temp_width = argument4;
var temp_height = argument5;

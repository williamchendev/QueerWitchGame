...
var chest_sprite = temp_sprites[3];
var legs_left_sprite = temp_sprites[4];
var legs_right_sprite = temp_sprites[5];
...
var arm_ground_dis = (sprite_get_bbox_bottom(arms_left_sprite) - sprite_get_yoffset(arms_left_sprite));
var chest_ground_dis = (sprite_get_bbox_bottom(chest_sprite) - sprite_get_yoffset(chest_sprite));
var leg_ground_dis = (sprite_get_bbox_bottom(legs_left_sprite) - sprite_get_yoffset(legs_left_sprite));
var chest_top_dis = (sprite_get_yoffset(chest_sprite) - sprite_get_bbox_top(chest_sprite)) + chest_ground_dis + (leg_ground_dis * 2);
...
var ragdoll_head_obj = instance_create_layer(temp_x, temp_y - chest_top_dis + head_offset, temp_layer, oRagdoll_Limb_Head);
ragdoll_head_obj.sprite_index = head_sprite;
ragdoll_head_obj.image_xscale = temp_image_xscale;
temp_limbs[0] = ragdoll_head_obj;

var ragdoll_arm1bot_obj = instance_create_layer(temp_x - (arm_offset * temp_image_xscale), temp_y - chest_top_dis + arm_ground_dis, temp_layer, oRagdoll_Limb_Arm);
...
var ragdoll_arm1top_obj = instance_create_layer(temp_x - (arm_offset * temp_image_xscale), temp_y - chest_top_dis, temp_layer, oRagdoll_Limb_Arm);
...
var ragdoll_chest_obj = instance_create_layer(temp_x, temp_y - (chest_ground_dis + (leg_ground_dis * 2)), temp_layer, oRagdoll_Limb_Chest);
ragdoll_chest_obj.sprite_index = chest_sprite;
ragdoll_chest_obj.image_xscale = temp_image_xscale;
temp_limbs[3] = ragdoll_chest_obj;

var ragdoll_arm2bot_obj = instance_create_layer(temp_x + (arm_offset * temp_image_xscale), temp_y - chest_top_dis + arm_ground_dis, temp_layer, oRagdoll_Limb_Arm);
...
temp_limbs[4] = ragdoll_arm2bot_obj;

var ragdoll_arm2top_obj = instance_create_layer(temp_x + (arm_offset * temp_image_xscale), temp_y - chest_top_dis, temp_layer, oRagdoll_Limb_Arm);
...
temp_limbs[5] = ragdoll_arm2top_obj;

var ragdoll_leftleg1_obj = instance_create_layer(temp_x - leg_offset, temp_y - (leg_ground_dis * 2), temp_layer, oRagdoll_Limb_Leg);
...
temp_limbs[6] = ragdoll_leftleg1_obj;

var ragdoll_rightleg1_obj = instance_create_layer(temp_x + leg_offset, temp_y - (leg_ground_dis * 2), temp_layer, oRagdoll_Limb_Leg);
...
temp_limbs[7] = ragdoll_rightleg1_obj;

var ragdoll_leftleg2_obj = instance_create_layer(temp_x - leg_offset, temp_y - leg_ground_dis, temp_layer, oRagdoll_Limb_Leg);
...
temp_limbs[8] = ragdoll_leftleg2_obj;

var ragdoll_rightleg2_obj = instance_create_layer(temp_x + leg_offset, temp_y - leg_ground_dis, temp_layer, oRagdoll_Limb_Leg);
...
temp_limbs[9] = ragdoll_rightleg2_obj;
